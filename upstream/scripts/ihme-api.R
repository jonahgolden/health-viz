...
risk_meta[cols.num] <- sapply(risk_meta[cols.num], as.numeric)
saveRDS(risk_meta, file = "../data/meta/risk-meta.RDS")
...
cause_meta[cols.num] <- sapply(cause_meta[cols.num], as.numeric)
saveRDS(cause_meta, file = "../data/meta/cause-meta.RDS")
